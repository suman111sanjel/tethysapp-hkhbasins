...
myApp.myMap = function () {
    ...
    myApp.view = new ol.View({
        center: [8605439.75929482, 4008722.0290474696],
        zoom: 5,
        // maxZoom: 10,
        // minZoom: 7,
...
myApp.AddLegend = function () {
    ...
    var labels = ["Hundred-year return period", "Fifty-year return period", "Twenty-five-year return period", "Ten-year return period", "Five-year return period", "Two-year return period ", "Normal Drainage"];
...
myApp.AddLayers = async function () {
    ...
    //     url: datasource,
    //     params: {
    //         'LAYERS': 'ECMWF_35:brahmaputraRiver,ECMWF_35:amudaryaRiver,ECMWF_35:gangesRiver,ECMWF_35:indusRiver',
    //         'TILED': true
    //     },
    ...
    myApp.riverLayerIdList = ['ECMWF_35amudaryaRiver', 'ECMWF_35brahmaputraBasin', 'ECMWF_35gangesRiver', 'ECMWF_35indusRiver'];
    let AmudaryaRiver = new ol.layer.Tile({
        id: 'ECMWF_35amudaryaRiver',
        title: 'Amu Darya',
        legendPath: LegendSource + 'ECMWF_35:amudaryaBasin',
        visible: true,
        source: new ol.source.TileWMS({
            url: datasource,
            params: {
                'LAYERS': 'ECMWF_35:amudaryaRiver,ECMWF_35:amudaryaBasin',
                'TILED': true
            },
            serverType: 'geoserver',
            crossOrigin: 'anonymous'
    ...
    myApp.map.addLayer(AmudaryaRiver);
    let l1 = new layerCheckBoxBinding(".layerCollection", AmudaryaRiver, false, true);


    let BrahmaputraRiver = new ol.layer.Tile({
        id: 'ECMWF_35brahmaputraBasin',
        title: 'Brahmaputra',
        legendPath: LegendSource + 'ECMWF_35:brahmaputraBasin',
        visible: true,
        source: new ol.source.TileWMS({
            url: datasource,
            params: {
                'LAYERS': 'ECMWF_35:brahmaputraRiver,ECMWF_35:brahmaputraBasin',
                'TILED': true
            },
            serverType: 'geoserver',
            crossOrigin: 'anonymous'
    ...
    myApp.map.addLayer(BrahmaputraRiver);
    let l2 = new layerCheckBoxBinding(".layerCollection", BrahmaputraRiver, false, true);


    let GangesRivers = new ol.layer.Tile({
        id: 'ECMWF_35gangesRiver',
        title: 'Ganges',
        legendPath: LegendSource + 'ECMWF_35:gangesBasin',
        visible: true,
        source: new ol.source.TileWMS({
            url: datasource,
            params: {
                'LAYERS': 'ECMWF_35:gangesRiver,ECMWF_35:gangesBasin',
                'TILED': true
            },
            serverType: 'geoserver',
            crossOrigin: 'anonymous'
    ...
    myApp.map.addLayer(GangesRivers);
    let l3 = new layerCheckBoxBinding(".layerCollection", GangesRivers, false, true);


    let IndusRiver = new ol.layer.Tile({
        id: 'ECMWF_35indusRiver',
        title: 'Indus',
        legendPath: LegendSource + 'ECMWF_35:indusBasin',
        visible: true,
        source: new ol.source.TileWMS({
            url: datasource,
            params: {
                'LAYERS': 'ECMWF_35:indusRiver,ECMWF_35:indusBasin',
                'TILED': true
            },
            serverType: 'geoserver',
            crossOrigin: 'anonymous'
    ...
    myApp.map.addLayer(IndusRiver);
    let l4 = new layerCheckBoxBinding(".layerCollection", IndusRiver, false, true);
...
myApp.BindControls = function () {
    ...
    myApp.map.on('singleclick', function (evt) {
        ...
        var hit = myApp.map.forEachLayerAtPixel(pixel, function (layer) {
            ...
            lyr = layer;
            if (myApp.riverLayerIdList.includes(prop.id)) {
                return true;
            } else {
                return false
            }
        ...
        if (hit) {
            ...
            var url = lyr.getSource().getGetFeatureInfoUrl(evt.coordinate,
                viewResolution,
                'EPSG:3857',
            ...
            if (url) {
                fetch(url)
                    ...
                    .then(function (html) {
                        ...
                        let regi = parsedJson.features[0].properties.region;
                        $.ajax({
                            type: "GET",
                            data: {
                                "stID": comid,
                            ...
                            "success": function (data) {
                                ...
                                get_forecast_percent(comid, regi);
...
let get_forecast_percent = function (comid, regi) {
